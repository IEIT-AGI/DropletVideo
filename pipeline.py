...
@dataclass
class DropletVideo_PipelineOutput(BaseOutput):
    r"""
...
class DropletVideo_Pipeline_Inpaint(DiffusionPipeline):
    r"""
    ...
    def __call__(
    ...
    ) -> Union[DropletVideo_PipelineOutput, Tuple]:
        """
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self.transformer(
                    ...
                    timestep_cond=torch.tensor(fps).to(timestep.device),
                    timestep=timestep,
        ...
        return DropletVideo_PipelineOutput(videos=video)